...
Możesz skorzystać z szablonu `mmajew/PRO1/Projekt_01/template.ipynb`.
Dowolna architektura sieci NN.
...
- warstwy użyte w Twojej NN, przykładowo: Input, Conv2D, BatchNormalization, Activation, MaxPooling2D,
GlobalAveragePooling2D, Flatten, Dense, Dropout, itd. Tylko takie, które używasz. Mniej używasz, mniej do nauki.
...
- jak interpretować macierz pomyłek? Co jest na osi X i Y? Jakie znaczenie ma przekątna macierzy pomyłek?
Co znaczą liczby poza przekątną?

Uwaga - można mieć ze sobą notatki lub komentarze w kodzie, które odpowiadają na w/w zagadnienia,
ale należy je wcześniej przeczytać i zrozumieć.
"""